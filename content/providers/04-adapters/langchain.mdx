---
title: LangChain
description: Learn how to use LangChain with the KhulnaSoft AI SDK.
---
...
Here is a basic example that uses both KhulnaSoft AI SDK and LangChain together with the [Next.js](https://nextjs.org/docs) App Router.
...
Then, we use the KhulnaSoft AI SDK's [`useCompletion`](/docs/ai-sdk-ui/completion) method in the page component to handle the completion:
...
You can find additional examples in the KhulnaSoft AI SDK [examples/next-langchain](https://github.com/khulnasoft/ai/tree/main/examples/next-langchain) folder.
