---
title: Azure OpenAI
description: Learn how to use Azure OpenAI with the KhulnaSoft AI SDK.
---
...
KhulnaSoft AI SDK provides a set of utilities to make it easy to use the [Azure OpenAI client library](https://learn.microsoft.com/en-us/javascript/api/overview/azure/openai-readme?view=azure-node-preview). In this guide, we'll walk through how to use the utilities to create a chat bot.
...
Create a Next.js application and install `ai` and `@azure/openai`, the KhulnaSoft AI SDK and Azure OpenAI client respectively:
