---
title: Inkeep
description: Learn how to use Inkeep with the KhulnaSoft AI SDK.
---

# Inkeep

KhulnaSoft AI SDK provides a set of utilities to make it easy to use [Inkeep](https://inkeep.com/)'s AI chat APIs to create chat experiences **powered by your own content**.
...
Create a Next.js application, install `ai`, the KhulnaSoft AI SDK, as well as [`@inkeep/ai-api`](https://github.com/inkeep/ai-api-ts), the Inkeep API SDK.
...
This example leverages a few utilities provided by the KhulnaSoft AI SDK:
...
2. We then pass that stream directly to the KhulnaSoft AI SDK's [`StreamingTextResponse`](/docs/reference/stream-helpers/streaming-text-response).
