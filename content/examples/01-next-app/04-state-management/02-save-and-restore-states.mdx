...
description: Learn to save and restore AI and UI states with onGetUIState and onSetAIState using the KhulnaSoft AI SDK in your Next.js App Router application
---
