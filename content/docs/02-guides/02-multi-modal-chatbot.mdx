...
description: Learn how to build a multi-modal chatbot with the KhulnaSoft AI SDK!
---
...
You've built a multi-modal AI chatbot using the KhulnaSoft AI SDK! Experiment and extend the functionality of this application further by exploring [tool calling](/docs/ai-sdk-core/tools-and-tool-calling) or introducing more granular control over [AI and UI states](/docs/ai-sdk-rsc/generative-ui-state).
