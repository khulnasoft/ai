---
title: RAG Chatbot
description: Learn how to build a RAG Chatbot with the KhulnaSoft AI SDK and Next.js
---
...
- [ KhulnaSoft AI SDK ](https://ai-sdk.khulnasoft.com/docs)
...
To reduce the scope of this guide, you will be starting with a [repository](https://github.com/khulnasoft/ai-sdk-rag-starter) that already has a few things set up for you:
...
<Snippet
  text={[
    'git clone https://github.com/khulnasoft/ai-sdk-rag-starter',
...
<Note>
  ...
  info](https://github.com/khulnasoft/ai-sdk-rag-starter/issues/1).
</Note>
...
You will use the KhulnaSoft AI SDK to create embeddings. This will require two more dependencies, which you can install by running the following command:

<Snippet text="pnpm install ai @ai-sdk/openai" />

This will install the [KhulnaSoft AI SDK](https://ai-sdk.khulnasoft.com/docs) and the [OpenAI provider](/providers/ai-sdk-providers/openai).
...
Great! Let's build the frontend. KhulnaSoft AI SDK’s [`useChat`](/docs/reference/ai-sdk-ui/use-chat) hook allows you to easily create a conversational user interface for your chatbot application.
...
In this code, you declare and export an asynchronous function called POST. You retrieve the `messages` from the request body and then pass them to the [`streamText`](/docs/reference/ai-sdk-core/stream-text) function imported from the KhulnaSoft AI SDK, alongside the model you would like to use. Finally, you return the model’s response in `AIStreamResponse` format.
...
- **parameters**: [Zod schema](https://ai-sdk.khulnasoft.com/docs/foundations/tools#schema-specification-and-validation-with-zod) that defines the parameters necessary for the tool to run.
