---
title: Embeddings
description: Learn how to embed values with the KhulnaSoft AI SDK.
---
...
The KhulnaSoft AI SDK provides the [`embed`](/docs/reference/ai-sdk-core/embed) function to embed single values, which is useful for tasks such as finding similar words
...
The KhulnaSoft AI SDK provides the [`embedMany`](/docs/reference/ai-sdk-core/embed-many) function for this purpose.
