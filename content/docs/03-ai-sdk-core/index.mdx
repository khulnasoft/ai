---
title: AI SDK Core
description: Learn about the KhulnaSoft AI SDK Core.
---
  ...
  cards={[
    {
      title: 'Overview',
      description:
        'Learn about the KhulnaSoft AI SDK Core and how to work with Large Language Models (LLMs).',
    ...
    {
      title: 'Tool Calling',
      description: 'Learn how to do tool calling with the KhulnaSoft AI SDK Core.',
      href: '/docs/ai-sdk-core/tools-and-tool-calling',
    },
    {
      title: 'Agents',
      description: 'Learn how to use agents with the KhulnaSoft AI SDK Core.',
    ...
    {
      title: 'Embeddings',
      description: 'Learn how to use embeddings with the KhulnaSoft AI SDK Core.',
