---
title: Settings
description: Learn how to configure the KhulnaSoft AI SDK.
---
...
All KhulnaSoft AI SDK functions support the following common settings in addition to the model, the [prompt](./prompts), and additional provider-specific settings:
