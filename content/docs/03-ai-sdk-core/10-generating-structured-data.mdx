...
description: Learn how to generate structured data with the KhulnaSoft AI SDK.
---
...
The KhulnaSoft AI SDK standardises structured object generation across model providers with the [`generateObject`](/docs/reference/ai-sdk-core/generate-object) function.
