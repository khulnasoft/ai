---
title: Prompts
description: Learn about the Prompt structure used in the KhulnaSoft AI SDK.
---
...
In order to simplify prompting across compatible providers, the KhulnaSoft AI SDK offers two categories of prompts: text prompts and message prompts.
