...
description: Learn how to migrate from KhulnaSoft AI SDK 3.0 to 3.1.
---
...
- Upgrade to KhulnaSoft AI SDK 3.1
- Migrate from [Legacy Providers](/providers/legacy-providers) to KhulnaSoft AI SDK Core
- Migrate from [`render`](/docs/reference/ai-sdk-rsc/render) to [`streamUI`](/docs/reference/ai-sdk-rsc/stream-ui)

Upgrading to KhulnaSoft AI SDK 3.1 does not require using the newly released AI SDK Core API or [`streamUI`](/docs/reference/ai-sdk-rsc/stream-ui) function. You can continue to use KhulnaSoft AI SDK with [existing (Legacy) providers](/providers/legacy-providers).

## Upgrading

### KhulnaSoft AI SDK

To update to KhulnaSoft AI SDK version 3.1, run the following command using your preferred package manager:

<Snippet text="pnpm install ai@3.1" />

## Next Steps

The release of KhulnaSoft AI SDK 3.1 introduces several new features that improve the way you build AI applications with the SDK:
...
With KhulnaSoft AI SDK Core you have a unified API for any provider that implements the [AI SDK Language Model Specification](https://sdk.vercel.ai/providers/community-providers/custom-providers).
