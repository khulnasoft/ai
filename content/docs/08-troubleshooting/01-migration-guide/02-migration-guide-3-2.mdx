...
description: Learn how to migrate from KhulnaSoft AI SDK 3.1 to 3.2.
---

# Migration Guide (3.1 to 3.2)

This guide will help you upgrade to KhulnaSoft AI SDK 3.2:
...
To update to KhulnaSoft AI SDK version 3.2, run the following command using your preferred package manager:
