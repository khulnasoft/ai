...
In this quickstart guide, you will explore the fundamental concepts behind KhulnaSoft AI SDK by building a Node.js chatbot that will run in your terminal.
...
You've built an AI chatbot using the KhulnaSoft AI SDK! Experiment and extend the functionality of this application further by exploring [tool calling](/docs/ai-sdk-core/tools-and-tool-calling) or [generating structured data](/docs/ai-sdk-core/generating-structured-data).
