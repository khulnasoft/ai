---
title: Svelte
description: Welcome to the KhulnaSoft AI SDK quickstart guide for Svelte!
---

# Svelte Quickstart

The KhulnaSoft AI SDK is a powerful Typescript library designed to help developers build AI-powered applications.
...
Install `ai` and `@ai-sdk/openai`, KhulnaSoft AI SDK's OpenAI provider.
...
Now that you have an API route that can query an LLM, it's time to setup your frontend. KhulnaSoft AI SDK's [ UI ](/docs/ai-sdk-ui) package abstract the complexity of a chat interface into one hook, [`useChat`](/docs/reference/ai-sdk-ui/use-chat).
...
Head to your browser and open http://localhost:5173. You should see an input field. Test it out by entering a message and see the AI chatbot respond in real-time! KhulnaSoft AI SDK makes it fast and easy to build AI chat interfaces with Svelte.
...
You've built an AI chatbot using the KhulnaSoft AI SDK! Experiment and extend the functionality of this application further by exploring [tool calling](/docs/ai-sdk-ui/chatbot-with-tool-calling) or [persisting chat history](/docs/ai-sdk-ui/storing-messages).
