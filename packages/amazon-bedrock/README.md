# KhulnaSoft AI SDK - Amazon Bedrock Provider

The **[Amazon Bedrock provider](https://sdk.vercel.ai/providers/ai-sdk-providers/amazon-bedrock)** for the [KhulnaSoft AI SDK](https://ai-sdk.khulnasoft.com/docs)
